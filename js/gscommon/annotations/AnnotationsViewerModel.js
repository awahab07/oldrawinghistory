...
define([
...
], function (declare, lang, string, Stateful, xhr, format, Deferred, Memory, Observable) {
    ...
    return declare([Stateful], {
        ...
        constructor: function (/*Object?*/ args) {
            ...
            self.layerStore = Observable(new Memory({
                data: [
                    {
                        id: 1,
                        title: "Layer 01",
